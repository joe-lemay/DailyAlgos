...
class MinHeap {
    ...
    insert(num) {
        ...
        while (startIndex > 1) {
            let parentIndex = Math.floor(startIndex / 2);
            if (this.heap[parentIndex] > this.heap[startIndex]) {
                [this.heap[parentIndex], this.heap[startIndex]] = [this.heap[startIndex], this.heap[parentIndex]];
